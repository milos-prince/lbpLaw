...
const IndexPage = () => (
  <Layout>
    ...
    <section className="textSection bg-light-green">
      ...
      <p>I am a Chartered Arbitrator designated by the ADR Institute of Canada and am an experienced adjudicator in labour, employment, and immigration matters. Many of my decisions have been published across several platforms, including CanLII, CLAD, CarswellNat, and WestLaw. These decisions include Canada Labour Code and Immigration and Refugee matters, among others.</p>
